        ...
        <div class="card">
            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title col-xl-6">اضافة مستخدم</h4>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2" action="{{route('users.store','test')}}" method="post">
                    ...
                    <a class="btn btn-primary float-left mt-3 mr-2" href="{{ route('users.index') }}">رجوع</a>

                    <button  class="btn btn-success float-left mt-3 mr-2" type="submit">تاكيد</button>
