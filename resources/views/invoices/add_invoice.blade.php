                ...
                <form action="{{route('invoices.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control fc-datepicker" name="invoice_date" type="text" placeholder="YYYY-MM-DD" value="{{date('Y-m-d')}}" required>
                        </div>
                        <!--Third Col-->
                        <div class="col">
                            <label>تاريخ الاستحقاق</label>
                            <input class="form-control fc-datepicker" name="due_date" type="text" placeholder="YYYY-MM-DD" required>
                        </div>
                    </div>
                    <!-- End First Row-->
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control form-control-lg" name="discount" id="discount" title="يرجي ادخال مبلغ الخصم" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="0" required>
                        </div>
                        <!--Third Col-->
                        <div class="col">
