								...
								<div class="card ">
									<div class="card-body">
										<div class="counter-status d-flex md-mb-0">
											...
											<div class="mr-auto">
												<h5 class="tx-13">بيع المنتجات</h5>
							...
							<div class="card-body">
									...
									<ul class="nav nav-tabs profile navtab-custom panel-tabs">
										<li class="">
											<a href="#home" data-toggle="tab" aria-expanded="true">
                                                ...
                                                <span class="hidden-xs">نبذة عنى</span>
                                            </a>
										</li>
										<li class="">
											<a href="#profile" data-toggle="tab" aria-expanded="false">
                                                ...
                                                <span class="hidden-xs">معرض الاعمال</span>
                                            </a>
										</li>
										<li class="">
											<a href="#settings" data-toggle="tab" aria-expanded="false">
                                                ...
                                                <span class="hidden-xs">اعدادات الحساب</span>
                                            </a>
										</li>
									</ul>
								...
								<div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                                    ...
                                    <div class="tab-pane active" id="home">
										<h4 class="tx-15 text-uppercase mb-3">نبذة عنى</h4>
										<p class="m-b-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
										<div class="m-t-30">
											<h4 class="tx-15 text-uppercase mt-3">الخبرة</h4>
											<div class=" p-t-10">
												<h5 class="text-primary m-b-5 tx-14">Developer</h5>
												<p class="text-muted">websitename.com</p>
												<p class="text-muted"><b>2014-2022</b></p>
												<p class="m-b-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
											</div>
										</div>
									</div>
									...
									<div class="tab-pane" id="settings">
										<form role="form">
											...
											<div class="form-group">
												...
												<input type="password" placeholder="{{ Auth::user() -> password }}" id="Password" class="form-control">
											</div>
